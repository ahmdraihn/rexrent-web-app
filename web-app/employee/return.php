...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'return') {
    ...
    $denda = floatval($_POST['denda_value'] ?? 0);
...
$activeRentals = $conn->query("
    SELECT t.*, p.nama as nama_pelanggan, p.noHP, m.merk, m.model, m.hargasewa, m.foto
    FROM tb_transaksi t
...
<body class="dashboard-page">
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="8" style="text-align:center;color:var(--brutal-gray);padding:40px 20px;">[ NO ACTIVE RENTALS ]</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    function calculateDenda() {
        ...
        const denda = keterlambatan * hargaSewaPerHari * 1.5;
