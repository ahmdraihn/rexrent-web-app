...
<head>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        brutal: {
                            black: '#2D406B',        /* Rex navy from logo */
                            white: '#fafafa',
                            gray: '#888888',
                            accent: '#E85D3B',       /* Rex orange from logo */
                            accentDark: '#C44A2B',   /* Darker orange */
                            blue: '#3B75D6',         /* Rex blue */
                            lightblue: '#A8C5E8',    /* Rex light blue */
                        }
                    },
                    fontFamily: {
                    ...
                    boxShadow: {
                        'brutal': '8px 8px 0px 0px #2D406B',
                        'brutal-lg': '12px 12px 0px 0px #2D406B',
                        'brutal-sm': '4px 4px 0px 0px #2D406B',
                    }
                }
            }
        }
    ...
    <style>
        * {
        ...
        .grid-bg {
            background-image:
                linear-gradient(rgba(45, 64, 107, 0.1) 1px, transparent 1px),
                linear-gradient(90deg, rgba(45, 64, 107, 0.1) 1px, transparent 1px);
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between h-20">
                <a href="#" class="flex items-center gap-3 group">
                    <img src="assets/images/logo.png" alt="Rex's Rents Logo" class="w-14 h-14 object-contain group-hover:scale-110 transition-transform">
                    <span class="font-display font-bold text-xl tracking-tighter hidden sm:block text-brutal-black">REX'S RENTS</span>
                </a>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <div class="inline-block bg-brutal-accent px-4 py-2 mb-6 border-3 border-brutal-black">
                        <span class="font-mono font-bold text-sm text-white">/// INDONESIA'S #1 CAR RENTAL</span>
                    </div>
                ...
                <div class="relative">
                    <div class="aspect-square border-4 border-brutal-black bg-brutal-black relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80" alt="Luxury Car" class="w-full h-full object-cover opacity-80 hover:opacity-100 hover:scale-110 transition-transform duration-500">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="border-4 border-brutal-black p-8 hover:bg-brutal-accent transition-colors group">
                    <i class="ti ti-currency-dollar w-16 h-16 mb-6 text-brutal-black group-hover:text-white"></i>
                    <h3 class="font-display font-bold text-2xl mb-4 text-brutal-black group-hover:text-white">BEST PRICES</h3>
                    <p class="font-mono text-sm text-brutal-black group-hover:text-white">Cheapest rates in Indonesia. Find a better price? We'll match it.</p>
                </div>

                <div class="border-4 border-brutal-black p-8 hover:bg-brutal-accent transition-colors group">
                    <i class="ti ti-car w-16 h-16 mb-6 text-brutal-black group-hover:text-white"></i>
                    <h3 class="font-display font-bold text-2xl mb-4 text-brutal-black group-hover:text-white">PREMIUM CARS</h3>
                    <p class="font-mono text-sm text-brutal-black group-hover:text-white">27 well-maintained vehicles. From city cars to supercars.</p>
                </div>

                <div class="border-4 border-brutal-black p-8 hover:bg-brutal-accent transition-colors group">
                    <i class="ti ti-lightning w-16 h-16 mb-6 text-brutal-black group-hover:text-white"></i>
                    <h3 class="font-display font-bold text-2xl mb-4 text-brutal-black group-hover:text-white">FAST BOOKING</h3>
                    <p class="font-mono text-sm text-brutal-black group-hover:text-white">Book online in 2 minutes. Pick up and drive. No paperwork hell.</p>
                </div>

                <div class="border-4 border-brutal-black p-8 hover:bg-brutal-accent transition-colors group">
                    <i class="ti ti-shield-check w-16 h-16 mb-6 text-brutal-black group-hover:text-white"></i>
                    <h3 class="font-display font-bold text-2xl mb-4 text-brutal-black group-hover:text-white">FULL INSURANCE</h3>
                    <p class="font-mono text-sm text-brutal-black group-hover:text-white">Every rental includes comprehensive insurance. Drive worry-free.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <div class="border-4 border-brutal-black p-8 bg-brutal-accent relative">
                    <div class="absolute -top-4 left-1/2 -translate-x-1/2 bg-brutal-black text-white px-4 py-1 font-mono text-sm font-bold">MOST POPULAR</div>
                    <div class="font-mono text-sm mb-4 text-white">[FAMILY]</div>
                    <h3 class="font-display font-bold text-3xl mb-2 text-white">MPV & SUV</h3>
                    <div class="font-mono text-sm mb-6 text-white">Avanza, Xpander, HRV, Innova</div>
                    <div class="font-display font-bold text-5xl mb-6 text-white">RP 350K<span class="text-lg font-mono">/day</span></div>
                    <ul class="font-mono text-sm space-y-3 mb-8 text-white">
                        <li>✓ 6-7 Seats</li>
                        <li>✓ Automatic</li>
                        <li>✓ Spacious</li>
                    ...
                    <a href="#fleet" class="block bg-brutal-black text-white font-mono font-bold text-center px-6 py-4 border-3 border-brutal-black hover:bg-white hover:text-brutal-black transition-colors">
                        BOOK NOW →
                    </a>
                </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    <div class="border-4 border-brutal-white p-8">
                        ...
                        <a href="#contact" class="inline-block bg-brutal-accent text-white font-mono font-bold px-8 py-4 border-4 border-brutal-black hover:shadow-brutal hover:translate-x-1 hover:translate-y-1 transition-all">
                            CONTACT US →
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="border-4 border-brutal-black p-8">
                    <div class="text-4xl mb-4 text-brutal-accent">★★★★★</div>
                    <p class="font-mono text-sm mb-6 text-brutal-black">"Finally a rental company that doesn't screw you over. Best prices, clean cars, no bullshit."</p>
                    <div class="font-display font-bold text-brutal-black">— AHMAD R.</div>
                    <div class="font-mono text-xs text-gray-500">Jakarta</div>
                </div>

                <div class="border-4 border-brutal-black p-8 bg-brutal-black text-white">
                    <div class="text-4xl mb-4 text-brutal-accent">★★★★★</div>
                ...
                <div class="border-4 border-brutal-black p-8">
                    <div class="text-4xl mb-4 text-brutal-accent">★★★★★</div>
                    <p class="font-mono text-sm mb-6 text-brutal-black">"Cheapest rates I found in Indonesia. The Lamborghini rental was a dream. Highly recommend."</p>
                    <div class="font-display font-bold text-brutal-black">— BUDI S.</div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="border-4 border-brutal-white p-8 text-center hover:bg-brutal-accent hover:text-brutal-black transition-colors">
                    <i class="ti ti-map-pin w-16 h-16 mb-4 text-brutal-white hover:text-brutal-black"></i>
                ...
                <div class="border-4 border-brutal-white p-8 text-center hover:bg-brutal-accent hover:text-brutal-black transition-colors">
                    <i class="ti ti-phone w-16 h-16 mb-4 text-brutal-white hover:text-brutal-black"></i>
                    <h3 class="font-display font-bold text-xl mb-4">PHONE</h3>
                    <p class="font-mono text-sm">0812-3456-7890<br>0813-9876-5432</p>
                </div>

                <div class="border-4 border-brutal-white p-8 text-center hover:bg-brutal-accent hover:text-brutal-black transition-colors">
                    <i class="ti ti-mail w-16 h-16 mb-4 text-brutal-white hover:text-brutal-black"></i>
                ...
                <div class="border-4 border-brutal-white p-8 text-center hover:bg-brutal-accent hover:text-brutal-black transition-colors">
                    <i class="ti ti-clock w-16 h-16 mb-4 text-brutal-white hover:text-brutal-black"></i>
        ...
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="tel:081234567890" class="bg-brutal-white text-brutal-black font-mono font-bold text-lg px-10 py-5 border-4 border-brutal-black hover:bg-brutal-black hover:text-brutal-white transition-all">
                    <i class="ti ti-phone"></i> 0812-3456-7890
                </a>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                <div>
                    <div class="flex items-center gap-3 mb-6">
                        <img src="assets/images/logo.png" alt="Rex's Rents Logo" class="w-12 h-12 object-contain">
                        <span class="font-display font-bold text-xl text-white">REX'S RENTS</span>
                    </div>
